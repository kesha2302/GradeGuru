    ...
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                ...
                <div class="d-flex">
                    <button type="button" onclick="window.location='{{ url('/Admin/DemoQueform') }}'"
                            ...
                            @foreach ($demoque as $dq)
                                <tr>
                                        ...
                                        @if (!empty($dq->question))
                                            <div class="description-container">
                                                <span class="description-text"
                                                    data-truncated="{{ Str::limit($dq->question, 100) }}">
                                                    {{ Str::limit($dq->question, 100) }}
                                                </span>
                                                @if (strlen($dq->question) > 100)
                                                    <button class="btn btn-link btn-sm more-btn"
                                                        data-description="{{ $dq->question }}">
                                                        More
                                                    </button>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('demoque.edit', ['id' => $dq->demoque_id]) }}">
        ...
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center">
                {{ $demoque->links('pagination::bootstrap-4') }}
            </div>
        </div>
