                ...
                @foreach ($className as $cn)
                    <div class="col-lg-4 mb-4">
                        <div class="card border-0 shadow-sm mb-2">
                            <img class="card-img-top mb-2" src="{{ asset('ClientView/img/blog-1.jpg') }}" alt="" />
                            <div class="card-body bg-light text-center p-4">
                                ...
                                <a href="{{ route('classprice.show', $cn->class_id) }}"
                                    class="btn btn-primary px-4 mx-auto my-2">View Details</a>
                            </div>
                        </div>
                    </div>
                @endforeach
