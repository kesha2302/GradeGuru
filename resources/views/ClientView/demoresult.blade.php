                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="border-start border-success ps-3">
                            ...
                            <h5 class="fw-bold text-success"><i class="bi bi-check-circle-fill me-1"></i>{{ $correct }}</h5>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="border-start border-danger ps-3">
                            <h6 class="text-muted">Wrong Answers</h6>
                            <h5 class="fw-bold text-danger"><i class="bi bi-x-circle-fill me-1"></i>{{ $wrong }}</h5>
                        </div>
                    </div>
                </div>
