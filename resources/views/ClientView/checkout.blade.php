    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            ...
            <h4 class="mb-4 mt-3 text-primary text-center">🧾 Checkout</h4>
             <h4 class="text-success fw-bold mb-0"> Total Amount: ₹{{ number_format(session('totalAmount', 0), 2) }}</h4>
            ...
            <form method="POST" id="bookingdetail">
             ...
             <div class="container text-center mt-3">
                <button type="button" onclick="validateAndPay()"
                    class="btn btn-success btn-lg">Confirm & Pay</button>
            </div>
        </div>
    </div>
</div>
